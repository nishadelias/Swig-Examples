...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__cointoss

#else
#  define SWIG_init    init_cointoss

#endif
#define SWIG_name    "_cointoss"
...
SWIGINTERN PyObject *_wrap_message(PyObject *self, PyObject *args) {
  ...
  (void)self;
  if (!SWIG_Python_UnpackTuple(args, "message", 0, 0, 0)) SWIG_fail;
  message();
...
SWIGINTERN PyObject *_wrap_cointoss(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  ...
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "cointoss" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = static_cast< int >(val1);
  result = (int)cointoss(arg1);
...
static PyMethodDef SwigMethods[] = {
	 { "message", _wrap_message, METH_NOARGS, NULL},
	 { "cointoss", _wrap_cointoss, METH_O, NULL},
	 { NULL, NULL, 0, NULL }
};
